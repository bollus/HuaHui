 ...
 * GoogleAuthenticator @Author: Strawberry @Description: @Date: 2021/07/15 18:10
 */
public class GoogleAuthenticator {
  ...
  public static String getGoogleAuthenticatorBarCode(
      String secretKey, String account, String issuer) {
    String normalizedBase32Key = secretKey.replace(" ", "").toUpperCase();
    try {
      return "otpauth://totp/"
