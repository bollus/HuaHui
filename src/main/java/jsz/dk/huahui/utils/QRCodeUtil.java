...
/**
 * @ProjectName: sign-management @Package: jsz.dk.signmanagement.utils @ClassName:
 * QRCodeUtil @Author: Strawberry @Description: @Date: 2021/07/15 20:55
 */
public class QRCodeUtil {
  ...
  public static String encode(
      String content, String logoPath, String destPath, boolean needCompress) throws Exception {
   ...
   */
  public static String encode(
      String content, String logoPath, String destPath, String fileName, boolean needCompress)
      throws Exception {
    BufferedImage image = QRCodeUtil.createImage(content, logoPath, needCompress);
    mkdirs(destPath);
    fileName =
