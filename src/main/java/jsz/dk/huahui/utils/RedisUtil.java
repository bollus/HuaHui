...
/**
 * @ProjectName: huahui @Package: jsz.dk.huahui.utils @ClassName: RedisUtil @Author:
 * Strawberry @Description: redis工具类 @Date: 2021/07/02 17:43
 */
...
public class RedisUtil {
  ...
  /**
   * 设置ASCII码, 字符串'a'的ASCII码是97, 转为二进制是'01100001', 此方法是将二进制第offset位值变为value postion 位置 value
   * 值,true为1, false为0
   */
  ...
  public Object lBRightPopAndLeftPush(
  ...
  public Set<Object> zReverseRangeByScore(
      String key, double min, double max, long start, long end) {
