package jsz.dk.huahui.interceptor.advice;

import jsz.dk.huahui.common.annotations.IgnoreResponseAdvice;
import jsz.dk.huahui.common.entity.ResponseParent;
import jsz.dk.huahui.configuration.DefaultProperties;
...
/**
 * @ProjectName: sign-management @Package: jsz.dk.signmanagement.interceptor.advice @ClassName:
 * BaseResponseAdvice @Author: Strawberry @Description: @Date: 2021/07/13 19:44
 */
...
public class BaseResponseAdvice implements ResponseBodyAdvice<Object> {
  ...
  private Boolean filter(MethodParameter methodParameter) {
    ...
    // 检查过滤包路径
    long count =
        defaultProperties.getAdviceFilterPackage().stream()
