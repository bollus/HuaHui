...
import jsz.dk.huahui.common.SnowflakeIdWorker;
...
/**
 * @ProjectName: sign-management @Package: jsz.dk.signmanagement.interceptor @ClassName:
 * SqlInterceptor @Author: Strawberry @Description: @Date: 2021/07/02 22:50
 */
...
public class SqlInterceptor extends AbstractSqlParserHandler implements Interceptor {
  ...
  public Object intercept(Invocation invocation) throws Throwable {
    ...
    // 是否为mybatis plus
    boolean isPlusUpdate =
        parameter.getClass().getDeclaredFields().length == 1
