package jsz.dk.huahui.aop;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import jsz.dk.huahui.common.annotations.OperationLogDetail;
import jsz.dk.huahui.common.entity.CustomException;
import jsz.dk.huahui.common.entity.OperationLog;
import jsz.dk.huahui.entity.User;
import jsz.dk.huahui.enums.CacheEnum;
import jsz.dk.huahui.utils.IPUtil;
...
/**
 * @ProjectName: sign-management @Package: jsz.dk.signmanagement.aop @ClassName: LogAspect @Author:
 * Strawberry @Description: @Date: 2021/07/12 16:11
 */
@Aspect
@Component
@Slf4j
public class LogAspect {
  ...
  @Pointcut("@annotation(jsz.dk.huahui.common.annotations.OperationLogDetail)")
  ...
  private String getDetail(
      String[] argName, Object[] args, OperationLogDetail annotation, User currentUser) {
  ...
  public void doBeforeAdvice(JoinPoint joinPoint) {
    ...
    log.info(
        "收到业务请求: client-ip:{}, request-uri:{}, method:{}, origin:{}, referer:{}, remote-user:{}, user-agent:{}",
        clientIp,
        requestUri,
        method,
        origin,
