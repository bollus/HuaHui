package jsz.dk.huahui.services.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import jsz.dk.huahui.common.entity.CacheKey;
import jsz.dk.huahui.common.entity.Consts;
...
import jsz.dk.huahui.enums.CacheEnum;
import jsz.dk.huahui.enums.ResponseCode;
import jsz.dk.huahui.mapper.UserMapper;
import jsz.dk.huahui.services.UserService;
import jsz.dk.huahui.utils.GoogleAuthenticator;
import jsz.dk.huahui.utils.QRCodeUtil;
import jsz.dk.huahui.utils.RedisUtil;
import jsz.dk.huahui.utils.Tools;
...
/**
 * @ProjectName: sign-management @Package: jsz.dk.signmanagement.services.impl @ClassName:
 * UserServiceImpl @Author: Strawberry @Description: @Date: 2021/07/02 18:15
 */
@Slf4j
@Service
public class UserServiceImpl implements UserService {
  ...
  public GoogleSecretVO generateGoogleSecret(User user) {
    ...
    String googleAuthenticatorBarCode =
        GoogleAuthenticator.getGoogleAuthenticatorBarCode(
            randomSecretKey, user.getUsername(), "运维管理平台");
  ...
  @Override
  @Transactional
  public void bindGoogle(GoogleDTO dto, User user, HttpServletRequest request)
    ...
    if (!GoogleAuthenticator.check_code(
        dto.getSecret(), dto.getCode(), System.currentTimeMillis())) {
  ...
  public void googleLogin(Long code, User user, HttpServletRequest request) throws CustomException {
    ...
    boolean isTrue =
        GoogleAuthenticator.check_code(user.getGoogleSecret(), code, System.currentTimeMillis());
    if (!isTrue) {
      throw new CustomException(TAG, "Google验证码不正确");
    }
