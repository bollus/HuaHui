package jsz.dk.huahui.controller;

import jsz.dk.huahui.common.annotations.NeedLogin;
import jsz.dk.huahui.common.annotations.OperationLogDetail;
import jsz.dk.huahui.common.controller.BaseController;
import jsz.dk.huahui.common.entity.CustomException;
import jsz.dk.huahui.common.entity.ResponseParent;
import jsz.dk.huahui.entity.User;
import jsz.dk.huahui.entity.dto.GoogleDTO;
import jsz.dk.huahui.entity.dto.GoogleLoginDTO;
...
import jsz.dk.huahui.enums.OperationType;
import jsz.dk.huahui.enums.OperationUnit;
...
/**
 * @ProjectName: sign-management @Package: jsz.dk.signmanagement.controller @ClassName:
 * UserController @Author: Strawberry @Description: @Date: 2021/07/02 18:18
 */
@RestController
...
public class UserController extends BaseController {
  ...
  @OperationLogDetail(
      detail = "用户登陆",
      level = 3,
      operationUnit = OperationUnit.GOOGLE,
